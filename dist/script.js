...
window.addEventListener('DOMContentLoaded', function () {
  var slider = new _modules_slider__WEBPACK_IMPORTED_MODULE_0__["Slider"]('.page', '.next'); // экземпляр класса

  slider.render();
  var player = new _modules_playVideo__WEBPACK_IMPORTED_MODULE_1__["VideoPlayer"]('.showup .play', '.overlay');
  player.init();
});
